...
package fi.matiaspaavilainen.masuiteportalsbridge.listeners.others;
...
public class PhysicsListener implements Listener {
    ...
    public void onBlockPhysics(BlockPhysicsEvent e) {
        if (!(e.getBlock().isLiquid() || e.getBlock().getType() == Material.PORTAL || e.getBlock().getType() == Material.ENDER_PORTAL)) {
            return;
        }
